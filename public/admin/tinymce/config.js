...
tinymce.init({
    ...
    toolbar1:
        "undo redo bold italic underline | alignleft aligncenter alignright alignjustify bullist numlist outdent indent blockquote link unlink anchor | preview | forecolor backcolor fullscreen code",
    image_advtab: true,
    menubar: false,
...
//     var src =
//         base_url() + "/file/dialog.php?field_id=" + field + "&akey=" + akey();
